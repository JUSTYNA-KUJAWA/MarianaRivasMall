    ...
    <div className={styles.root}>
      ...
      <div className={styles.navLinks}>
        <ul className={clsx(isNavExpanded && styles.isExpanded)}>
          ...
          <li><NavLink to="/Ceramique" className={({ isActive }) => isActive? styles.active : styles.inActive}>Ceramique</NavLink></li>
          <li><NavLink to="/Arts" className={({ isActive }) => isActive? styles.active : styles.inActive}>Arts</NavLink></li>
          <li><NavLink to="/Paint" className={({ isActive }) => isActive? styles.active : styles.inActive}>Paint</NavLink></li>
          <li><NavLink to="/Books" className={({ isActive }) => isActive? styles.active : styles.inActive}>Books</NavLink></li>
